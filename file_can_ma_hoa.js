...
/////////////////////////////////////////////////////////////////////////////////////////////////////
// css pseudo trong javascript  nếu cần đọc lại học để css bằng javascript không cần dùng file css nữa
//   function pseudo() {
//     var _class = [
...
//       var obj = {};
//       let len = _class.length;
//       for (let index = 0; index < len; index++) {
//         let x = _class[index][0].slice(1);
//         sheet_style(
//           "." + myname + x + _class[index][1],
//           _class[index][2],
//           mySheet
//         );
//         obj[x] = myname + x;
...
//   var pseudo = pseudo() ;
// hàm pseudo trả về một đối tượng
//<div className={ pseudo.black} > ví dụ </div>
      ...
      <div   onMouseMove ={(event) => { _onMouseMove(event)    }} onMouseOut ={(event) => { _onMouseOut(event)    }}  ref={ ref_0  } style={{  position: "relative"}}  > 
        ...
        <div style={{   display: "flex",   flexWrap: 'wrap', }} > 
               <div style={{  flexBasis: '100%',  display: "flex", }} >   <div className='far fa-file-excel'  style={{    fontSize: '16px', color: '#00A170 ',padding : '2px', margin : '2px 2px 2px 0px', }}  ></div>    <div  ref={ ref_file_name  } contentEditable="true" style={{  padding : '2px', margin : '2px 2px 2px 0px' ,   minWidth: '200px',}}  className={ pseudo.black}  > New file {  new Date().getFullYear()+ "_"+ (new Date().getMonth() + 1 )  + "_" + new Date().getDate()} </div>  </div>  
                  ...
                  <div  style={{ border: "1px solid #00A170" ,  padding : '2px',   margin : '2px'}} className={ pseudo.black} onClick={ (event) => {   open_file_computer(event) ; } } > file_computer </div>  
                  <div  style={{ border: "1px solid #00A170" ,  padding : '2px',   margin : '2px'}} className={ pseudo.black} onClick={ (event) => {  save_as_file_computer(event) ; } } > save_as_computer </div>  
                  <div  style={{ border: "1px solid #00A170" ,  padding : '2px',   margin : '2px'}} className={ pseudo.black} onClick={ (event) => {  save_file_computer(event) ; } } > save_computer </div>  
       </div>
